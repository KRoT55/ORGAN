...
public class RussianMainItemHeader implements IMainLanguageHeader, Serializable {

    @Override
    public String[] getFileMenuHeader() {
        return new String[]{"Файл","Закрыть"};
    }

    @Override
    public String[] getEditMenuHeader() {
        return new String[]{"Правка","Настройки"};
    }

    @Override
    public String[] getHelpMenuHeader() {
        return new String[]{"Помощь","О программе"};
    }

    @Override
    public String[] getManageEventButtonHeader() {
        return new String[]{"Новое событие", "Обновить событие", "Удалить событие"};
    }
